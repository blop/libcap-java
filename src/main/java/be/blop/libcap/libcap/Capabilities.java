...
public interface Capabilities {
	 ...
	 */
	int CAP_LINUX_IMMUTABLE = 9;

	/**
	 * Allows binding to TCP/UDP sockets below 1024
	 * Allows binding to ATM VCIs below 32
	 */
	int CAP_NET_BIND_SERVICE = 10;

	/**
	 * Allow broadcasting, listen to multicast
	 */
	int CAP_NET_BROADCAST = 11;
	 ...
	 */
	int CAP_IPC_OWNER = 15;

	/**
	 * Insert and remove kernel modules - modify kernel without limit
	 */
	int CAP_SYS_MODULE = 16;

	/**
	 * Allow ioperm/iopl access
	 * Allow sending USB messages to any device via /proc/bus/usb
	 */
	int CAP_SYS_RAWIO = 17;

	/**
	 * Allow use of chroot()
	 */
	int CAP_SYS_CHROOT = 18;

	/**
	 * Allow ptrace() of any process
	 */
	int CAP_SYS_PTRACE = 19;

	/**
	 * Allow configuration of process accounting
	 */
	int CAP_SYS_PACCT = 20;
	 ...
	 */
	int CAP_AUDIT_WRITE = 29;

	/**
	 * Allow configuration of audit via unicast netlink socket
	 */
	int CAP_AUDIT_CONTROL = 30;
	 ...
	 */
	int CAP_WAKE_ALARM = 35;

	/**
	 * Allow preventing system suspends
	 */
	int CAP_BLOCK_SUSPEND = 36;
}